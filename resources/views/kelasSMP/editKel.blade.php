...
<h1 class="text-center" style="margin-top: 10%">Update Nama Kelas <span class="text-warning">(SMP)</span></h1>

<div class="container">
    <div class="row" style="margin-top: 6%">
    <div class="col-3"></div>
    <form class="col-6" method="POST" action="{{ route('kelasSMP.update', [$kel->id]) }}">
        @csrf
        @method('PUT')
        <div class="mb-3">
