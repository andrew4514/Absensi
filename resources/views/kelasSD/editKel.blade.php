...
<h1 class="text-center" style="margin-top: 10%"><span class="text-warning">Update</span> Nama Kelas</h1>

<div class="container">
    <div class="row" style="margin-top: 6%">
    <div class="col-3"></div>
    <form class="col-6" method="POST" action="{{ route('kelasSD.update', [$kel->id]) }}">
        @csrf
        @method('PUT')
        <div class="mb-3">
